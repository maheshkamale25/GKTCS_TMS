...
from .models import Student, Course, Announcement, Assignment, Submission, Material, Student,Faculty, Department
...
def register_view(request): 
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Get the actual Department instance
            try:
            ...
            try:
                if role == 'student':
                    ...
                    if Faculty.objects.filter(faculty_id=user_id).exists():
                        error_message = "Faculty ID already exists."
                    else:
                ...
                error_message = "An unexpected error occurred while saving the data."
    else:
